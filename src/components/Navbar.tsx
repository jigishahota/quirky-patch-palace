    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-white border-b">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/super-nova-box" className="font-semibold hover:text-primary transition-colors">Super Nova Box</Link>
        ...
        {isMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-white border-b md:hidden py-4 px-4 flex flex-col gap-4">
            ...
            <Link to="/super-nova-box" className="font-semibold py-2 hover:text-primary transition-colors">Super Nova Box</Link>
